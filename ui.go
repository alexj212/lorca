...
type UI interface {
	...
	Done() <-chan struct{}
	Close() error
	ExposeTargetMessage(messageHandler ExposeTargetMessage)
}
...
func (u *ui) ExposeTargetMessage(messageHandler ExposeTargetMessage){
	u.chrome.targetMessageHandler = messageHandler
}